<div class="box">
    <div class="box-header">
        <h3 class="box-title"><?php echo trans('web.amenityList');?></h3>
    </div>
    <!-- /.box-header -->
    ...
    <div class="box-body">
        ...
        <form role="form" method="post" id="profileForm" action='/admin/actionCreateAmenity'>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="amentity_name" name="amentity_name" placeholder="Enter Amenity">
                        </div>
                        <div class='col-md-2'>
            ...
            <tbody>
                ...
                for ($i = 0; $i < count($data); $i++) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href='/admin/actionDeleteAmenity/<?php
                            echo $data[$i]->id;
