...
<script>
    ...
    function createClass()
    {
        ...
        formElement.action = "/admin/actionCreateClass";
        formElement.submit();
        return;
    }
</script>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="email" class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57' id="class_value" name="class_value" placeholder="<?php echo trans('web.spot');?>">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                        ...
                        <div class="col-md-3" id="divEndDate">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control pull-right" onchange="changeDate('reservation1')" name="class_dateend" id="reservation1">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="bootstrap-timepicker">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="class_endtime" id="class_endtime" onchange="changeEndTime('class_starttime','class_endtime');" class="form-control timepicker">
