<div class="box">
    <div class="box-header">
        <h3 class="box-title"><?php echo trans('web.activityList');?></h3>
    </div>
    <!-- /.box-header -->
    ...
    <div class="box-body">
        ...
        <form role="form" method="post" id="profileForm" action='/admin/actionCreateActivity'>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="location_name" name="activity_name" placeholder="Enter Activity">
                        </div>
                        <div class='col-md-2'>
            ...
            <tbody>
                ...
                for ($i = 0; $i < count($data); $i++) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href='/admin/actionDeleteActivity/<?php
                            echo $data[$i]->id;
                            ;
