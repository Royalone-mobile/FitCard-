...
<script>
    ...
    function createCompany()
    {
        ...
        formElement.action = "/admin/formCreateCompany";
        formElement.submit();
        return;
    }
    function changePsd()
...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><?php echo trans('web.createCompany');?></h3>
    </div>    
    <div class="box box-primary">
        <form name="form_logo" style="margin-left:20px;" id="form_logo" method="post" action="/admin/ajaxUploadGymLogo">
            ...
            <!-- SIDEBAR USERPIC -->
            <div class="profile-userpic"> <img src="" style="height:159px;width:350px;"id="imgBusinessLogo" onclick="document.getElementById('upload').click();
        ...
        <form role="form" method="post" id="profileForm">
            <input type="hidden" name="company_image" id="imagePath" style="visibility: hidden; width: 1px; height: 1px">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="email" class="form-control" id="company_name" name="company_name" placeholder="<?php echo trans('web.name');?>">
                        </div>
                        <div class="col-md-3">
                            <label for="exampleInputEmail1"><?php echo trans('web.owner');?></label>
                            <input type="email" class="form-control" id="company_owner" name="company_owner" placeholder="<?php echo trans('web.owner');?>">
                        </div>                                                
                        <div class="col-md-3">
                            <label for="exampleInputEmail1"><?php echo trans('web.email');?></label>
                            <input type="email" class="form-control" id="company_email" name="company_email" placeholder="<?php echo trans('web.email');?>">
                        </div>   
                    </div>  
                </div>                 
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="email" class="form-control" id="company_account" name="company_account" placeholder="<?php echo trans('web.account');?>">
                        </div>
                        <div class="col-md-3">
                            ...
                            <input type="email" class="form-control" id="company_password" name="company_password" placeholder="<?php echo trans('web.password');?>">                            
                        </div>
                        <div class="col-md-3">
                            <label for="exampleInputEmail1"><?php echo trans('web.phone');?></label>
                            <input type="email" class="form-control" id="company_phone" name="company_phone" placeholder="<?php echo trans('web.phone');?>">
                        </div>   
                    </div>                    
                </div>        
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="email" class="form-control" id="company_country" oninput="getCoor()" name="company_country" placeholder="<?php echo trans('web.country');?>">
                        </div>
                         <div class="col-md-3">
                            <label for="exampleInputEmail1"><?php echo trans('web.city');?></label>
                            <input type="email" class="form-control" oninput="getCoor()" id="company_city" name="company_city" placeholder="<?php echo trans('web.city');?>">
                        </div>                      
                        <div class="col-md-3">
                            <label for="exampleInputEmail1" ><?php echo trans('web.location');?></label>
                            <input type="email" class="form-control" oninput="getCoor()" id="company_location" name="company_location" placeholder="<?php echo trans('web.location');?>">
                        </div>      
                        <div class="col-md-3">
                ...
                <div class="form-group">
                    <div class="row">                       
                        <div class="col-md-3">
                            ...
                            <input type="email" class="form-control" id="company_zip" name="company_zip" placeholder="<?php echo trans('web.zipCode');?>">                            
                        </div>                           
                        <div class="col-md-3">
                            <label for="exampleInputEmail1"><?php echo trans('web.latitude');?></label>
                            <input type="email" class="form-control" id="company_lat" name="company_lat" placeholder="<?php echo trans('web.latitude');?>">
                        </div>   
                        <div class="col-md-3">
                            <label for="exampleInputEmail1"><?php echo trans('web.longitude');?></label>
                            <input type="email" class="form-control" id="company_lng" name="company_lng" placeholder="<?php echo trans('web.longitude');?>">
                        </div>   
                    </div>                    
                </div>    
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="email" class="form-control" id="company_bank" name="company_bank" placeholder="<?php echo trans('web.bank');?>">
                        </div>
                        <div class="col-md-3">
                            <label for="exampleInputEmail1"><?php echo trans('web.vatNumber');?> </label>
                            <input type="email" class="form-control" id="company_vat"  name="company_vat" placeholder="<?php echo trans('web.vatNumber');?>">                            
                        </div>                                                   
                    </div>                    
                </div>    
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="email" class="form-control" id="company_description" name="company_description" placeholder="<?php echo trans('web.description');?>">
                        </div>                                                                         
                    </div>                    
                </div>    
            </div>
        ...
        <div class="box-footer">
            <button class="btn btn-primary" onclick="createCompany()"><?php echo trans('web.create');?></button>
        </div>
        <!-- /.box-body -->
    </div>
</div>
