<div class="box">
    <div class="box-header">
        <h3 class="box-title"><?php echo trans('web.gymCategory');?></h3>
    </div>
    <!-- /.box-header -->
    ...
    <div class="box-body">
        ...
        <form role="form" method="post" id="profileForm" action='/admin/actionCreateGymCategory'>
            ...
            <tbody>
                ...
                for ($i = 0; $i < count($data); $i++) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href='/admin/actionDeleteGymCategory/<?php
                            echo $data[$i]->id;
                            ;
