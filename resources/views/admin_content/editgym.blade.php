...
<script>
    ...
    function updateGym()
    {
        ...
        formElement.action = "/admin/actionUpdateGym";
        formElement.submit();
        return;
    }
...
<div class="box">
    ...
    <div class="box box-primary">
        <div class="box-body">
            ...
            <form role="form" method="post" id="profileForm">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="email" class="form-control" id="gym_bankaccount" value="<?php echo $gymInfo->bankaccount; ?>" name="gym_bankaccount" placeholder="<?php echo trans('web.bank');?>">
                        </div>
                        <div class="col-md-3">
                            <label for="exampleInputEmail1"><?php echo trans('web.usuability');?></label>
                            <input type="email" class="form-control" id="gym_usability" name="gym_usability" value="<?php echo $gymInfo->usability; ?>" placeholder="<?php echo trans('web.usuability');?>">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="row">
                  <div class="col-md-2">
                  <?php
                    if ($gymInfo->visitcode == 1)
                    {
                    ?>
                    <input name="visitCode" checked value="1" type="checkbox"> Enable Visit Code</input>
                    <?php
                    }
                    else
                    {
        ...
        <div class="box-footer">
            ...
            <a href="/admin/gyms"><button class="btn btn-primary"><?php echo trans('web.cancel');?></button></a>
        </div>
        <!-- /.box-body -->
    </div>
</div>
