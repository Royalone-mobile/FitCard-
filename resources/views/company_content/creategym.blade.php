...
<script>
    ...
    function createPlayer()
    {
        ...
        formElement.action = "/company/actionCreateGym";
        formElement.submit();
        return;
    }
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="email" class="form-control" id="gym_bankaccount" name="gym_bankaccount" placeholder="<?php echo trans('web.bankAccount');?>">
                        </div>
                        <div class="col-md-3">
                            <label for="exampleInputEmail1"><?php echo trans('web.usability');?></label>
                            <input type="email" class="form-control" id="gym_usability" name="gym_usability" placeholder="<?php echo trans('web.usability');?>">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            -->
                            <input type="hidden" value="<?php echo $companyInfo->id; ?>" name="gym_company"/>
                        </div>
