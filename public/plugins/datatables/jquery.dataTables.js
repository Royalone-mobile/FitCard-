...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sEmptyTable": "Tietoa ei saatavilla",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "ei 0 to 0 of 0 näkymää",
			 ...
			 *    } );
			 */
			"sLengthMenu": "Näytä _MENU_ tuntia",
	...
	$.extend( extPagination, {
		...
		simple_numbers: function ( page, pages ) {
			return [ 'Edellinen', _numbers(page, pages), 'Seuraava' ];
		},
	
		full_numbers: function ( page, pages ) {
			return [ 'first', 'Edellinen', _numbers(page, pages), 'next', 'Seuraava' ];
		},
